...
const AuthState = ({ children }) => {
  ...
  const cerrarSesion = () => {
     ...
     * podemos clickar en el boton de Atrás del navegador y podemos tener problemas.
     * replace() mismo comportamiento pero borra el historial de navegación de nuestrp
     * proyecto
     */
