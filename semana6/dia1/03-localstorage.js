...
formPreferencias.onsubmit = (e) => {
   ...
   */
  let objetoString = JSON.stringify(objPreferencias);
  // console.log(objetoString);

  localStorage.setItem("preferencias", objetoString);
};
...
inputColor.onchange = (e) => {
   ...
   * Crea una clave => valor en el localstorage del
   * navegador y permanece si el navegador se cierra.
   */
...
const verificarStorage = () => {
   ...
   * esa clave, si no hay ningun valor con esa clave, retorna NULL
   */
